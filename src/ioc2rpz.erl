...
parse_dns_request(Socket, Data, Proto) when byte_size(Data)<6 -> 
  ioc2rpz_fun:logMessageCEF("|101|Empty request|3|src=~p proto=~p~n",[ip_to_str(Proto#proto.rip),Proto#proto.proto]);
