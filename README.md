...
ioc2rpz is a custom built DNS server which natively support different file formats, protocols and transforms threat intelligence into actionable RPZ feeds. The feeds can be used on any DNS server which support RPZ.  
